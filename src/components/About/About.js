    ...
    <AboutSection id="about">
      ...
      <AboutContainer>
        <AboutText>
          ...
          <br /> <br />
          When I was a kid, instead of going to the beach on vacation, I would go to science museums. I was so amazed at how we can 
          travel thousands of miles in outer space by lighting liquid on fire in a space ship, or 
          how we can stick someone in a huge magnet and see inside their freaking brain with an MRI, and 
          I mean, who would've thought of using the LITERAL SUN so you can watch TV in your house with a solar panel?
          Finding out that I could harness my own creativity to solve problems in the world is what drove me to 
      ...
      <AboutText>
        ...
        as an Information Technology Intern, Verizon as a 5G Engineering Co-op, AMETEK as a Product Development Intern. These multifaceted experiences showed me product development for medical devices, 
